    ...
    <>
      <div className={styles.invoice}>
          ...
          <div className={styles.itemsdescription}>
            <div className={styles.columnBreak}>
              ...
              <div className={styles.rate}>
                <p className={styles.rateOne}>
                  Quantity <span>Rate</span>
                </p>
                <p>Amount</p>
              </div>
            </div>
            ...
            <div className={styles.notes}>
              <div>
                ...
                >
                  Note any relevant information not already covered
                </textarea>
              </div>
              <div className={styles.subtotal}>
                <p className={styles.subAmt}>
        ...
        <div className={styles.columRight}>
          ...
          <p>Currency:USD</p>
          <p className={styles.save} onClick={() => setShowInvoice(true)}>
            Save Template
          </p>
          <hr />
          <p>My Invoice </p>
    ...
    <>
      <div className={styles.invoice}>
        <div className={styles.invoiceContainer}>
          <div className={styles.flex}>
            <div className={styles.leftInvoiceContent}>
              ...
              <label>{`From:${formData.sender}`}</label>
              <label>{`Bill To:${formData.receiver}`}</label>
              <label>{`Address:${formData.address}`}</label>
              <label>{`Telephone:${formData.telephone}`}</label>
            </div>
            <div className={styles.rightInvoiceContent}>
              <div>
                <h2>INVOICE</h2>
          ...
          <div className={styles.itemsdescription}>
            ...
            <div className={styles.itemQuantity}>
              <div>
                ...
                >{`item description:${formData.item}`}</p>
              </div>
        ...
        <div className={styles.btns}>
          ...
          <button onClick={handleDownload()} className={styles.lineBtn}>
            Download invoice
          </button>
        </div>
      </div>
